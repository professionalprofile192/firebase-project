...
export async function POST(req: Request) {
  try {
    ...
    const externalApiUrl = "https://prodpk.ubldigital.com/services/data/v1/DCP_Approvals_OB_Object/operations/ApprovalMatrix/fetchUserRequestHistory";

    // Payload as per your logs (History uses approveDate for sorting)
    const payload = {
      userId: userId,
      searchString: "",
      sortBy: "approveDate",

  ...
  if (values.username === 'raaststp' && values.password === 'Kony@123456') {
    return {
      ...
      profile: {
        ...
        firstname: 'Nawaz',
        lastname: 'Ali',
        email: 'humna.sadia@gmail.com.pk',
...
export async function sendOtpForUsernameRecovery(values: { email: string, mobileNumber: string }) {
    ...
    if (values.email === 'humna.sadia@gmail.com.pk' && values.mobileNumber === '03343498426') {
      return {
...
export async function verifyOtp(values: { otp: string, email: string, mobileNumber: string }) {
    ...
    if (values.email === 'humna.sadia@gmail.com.pk' && values.mobileNumber === '03343498426' && values.otp === '123456') {
        return {
            "isOtpVerified": "true",
            "opstatus": 0,
            "httpStatusCode": 200,
